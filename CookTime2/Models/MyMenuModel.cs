namespace CookTime2.Models
{
    ...
    public partial class MyMenuModel
    {
    ...
    public partial class MyMenuModel
    {
        public static MyMenuModel[] FromJson(string json) => JsonConvert.DeserializeObject<MyMenuModel[]>(json, CookTime2.Models.Converter.Settings);
    }
}